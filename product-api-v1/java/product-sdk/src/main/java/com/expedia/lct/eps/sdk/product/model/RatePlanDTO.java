...
public class RatePlanDTO   {
  ...
  @ApiModelProperty(example = "null", value = "Returned to indicate whether the rate being exchanged over other APIs (availability/rates or booking) is inclusive of taxes or not. During creation, for properties managing net rates, the default value is false. For sell rates, it is based on the property's configuration")
  ...
  @ApiModelProperty(example = "null", value = "Indicates this rate plan is only available through shopping done on mobile devices")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.resourceId, ratePlanDTO.resourceId) &&
        ...
        Objects.equals(this.additionalGuestAmounts, ratePlanDTO.additionalGuestAmounts) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(resourceId, name, rateAcquisitionType, distributionRules, status, type, pricingModel, occupantsForBaseRate, taxInclusive, cancelPolicy, additionalGuestAmounts, valueAddInclusions, minLOSDefault, maxLOSDefault, minAdvBookDays, maxAdvBookDays, bookDateStart, bookDateEnd, travelDateStart, travelDateEnd, mobileOnly);
  }
