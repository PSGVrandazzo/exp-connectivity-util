...
public class PropertyDTO   {
  ...
  private Boolean baseAllocationEnabled = null;
  private String cancellationTime = null;
  private String currency = null;


  public enum DistributionModelsEnum {
    EXPEDIACOLLECT("ExpediaCollect"),
    HOTELCOLLECT("HotelCollect");

    private String value;

    DistributionModelsEnum(String value) {
      this.value = value;
    }
  ...
  private List<DistributionModelsEnum> distributionModels = new ArrayList<DistributionModelsEnum>();
  ...
  public enum StatusEnum {
    ...
    UNDERCONVERSION("UnderConversion");
  ...
  @ApiModelProperty(example = "false", value = "Boolean to indicate whether this property has a base allocation contract with Expedia.")
   ...
   **/
  public PropertyDTO distributionModels(List<DistributionModelsEnum> distributionModels) {
  ...
  public List<DistributionModelsEnum> getDistributionModels() {
    return distributionModels;
  }
  public void setDistributionModels(List<DistributionModelsEnum> distributionModels) {
    this.distributionModels = distributionModels;
  }
  ...
  @ApiModelProperty(example = "false", value = "Returned to indicate whether the rate being exchanged over other APIs (availability/rates or booking) is inclusive of taxes or not.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.address, propertyDTO.address) &&
        ...
        Objects.equals(this.resourceId, propertyDTO.resourceId) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(address, baseAllocationEnabled, cancellationTime, currency, distributionModels, minLOSThreshold, name, partnerCode, pricingModel, rateAcquisitionType, reservationCutOff, resourceId, status, taxInclusive, timezone);
  }
